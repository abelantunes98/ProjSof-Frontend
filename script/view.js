    ...
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" />
                <div class="resultado">
                    ...
                    <div id="comentario">
                        ...
                        <button id="btn-msgPai" class="btn">Enviar</button>
                    </div>
                </div>`
    let novo = document.createElement("div");
    novo.setAttribute("id", "mostrar");
...
function viewComentario() {
    ...
    for (let i = 0; i < comentarios.length; i++) {
        ...
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" />
                    ...
                    <p id="msg-pai">${comentarios[i].comment_msg}</p>
                    <p id="nome-usuario">${comentarios[i].user_name}</p>
                    <button id="${id_button}" class="btn-apagar material-icons">delete</button>
                    <time id="hora">Em: ${comentarios[i].data}</time>
...
function viewRespComentario(commentId) {
    ...
    document.getElementById("btn-msgPai").onclick = (() => { responderComentario(commentId) });
}
