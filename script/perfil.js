...
async function responderComentario(idcomentario) {
    ...
    const url = "https://projsof.herokuapp.com/api/comments/postCommentOfAnswer/" + idcomentario;
    const corpo = { "id_subject": subject.id, "comment_msg": msg };
    const method = 'POST';
...
export { darLike, darDeslike, enviaComentario, deletaComentario, responderComentario };